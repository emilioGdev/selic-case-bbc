...
def aggregate_selic_data() -> None:
    ...
    mensais e anuais da taxa SELIC.
    """
    ...
    print("Calculando taxa acumulada anual...")
    
    annual_df = df.groupby(["ano"])["valor"].sum().reset_index()
    annual_df = annual_df.rename(columns={"valor": "acumulado_anual"})
